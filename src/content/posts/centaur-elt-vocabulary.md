...
1. Prompt crafting.
2. A live demo of the prompt in action and,
3. My reflections on the experience.

My first prompt experiment was about [Wellbeing in ELT](https://damien-herlihy-a-galaxy-of-knowledge.webflow.io/post/centaur-elt-wellbeing). While in this post, I'm going to share with you a prompt to help students remember new vocabulary.
...
1. Can you name one method you use to memorize new vocabulary?
2. What do you find challenging about memorizing new words?
3. Describe a situation where you successfully remembered a new word. What techniques did you use?
...
Mollick, E., & Mollick, L. (2024). *Instructors as Innovators: A Future-focused Approach to New AI Learning Opportunities, with Prompts*. Wharton School of the University of Pennsylvania.
