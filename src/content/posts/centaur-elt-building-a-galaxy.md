---
title: "Centaur ELT: Building a Galaxy When You Can't Code"
date: 2026-08-03
category: "AI & Teaching"
tag: "Star (Note)"
featured: false
description: "The first episode of Centaur ELT. How Maggie Appleton's digital garden became a digital universe, why not knowing Three.js didn't stop me, and what art direction looks like when the AI writes the code."
...
The process wasn't one-shot. The starting prompt was fairly simple, and what came back was a starting point. From there it was iteration: accept what fits, reject what doesn't, describe what's missing, run it again. Repeat. This felt like taste in action. You look at something, you know it isn't right yet, and you keep going until it is.

Teachers have this skill already. Knowing a lesson isn't landing while it's still happening, and adjusting on the spot, is exactly the same loop. Reject what doesn't work, accept what does, build toward the thing you were aiming for. The context is different; the muscle is the same.

The practical takeaway from this first episode: describe your vision in a prompt, run multiple iterations, and treat the rejection of what doesn't fit as the work itself, not as failure.

---

Episode 1 of Centaur ELT is embedded above. It's a diary, not a fixed run, so more episodes will follow as the work does. [Subscribe to the YouTube channel](https://www.youtube.com/@damienherlihy) if you want them. And if you'd rather get this kind of thinking straight to your inbox, my newsletter [disASTER](https://dis-aster.vercel.app/) is where it lives.
